    ...
    ***************************************************************************** */
    ...
    var MathBackendWebGL = /** @class */ (function (_super) {
        ...
        MathBackendWebGL.prototype.readToGPU = function (dataId, options) {
            ...
            var tensorRef = tf.engine().makeTensorFromDataId(tmpTarget.dataId, tmpTarget.shape, tmpTarget.dtype);
            ...
            return (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (!(tf.env()
                                .getNumber('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_RELIABLE') > 0)) return [3 /*break*/, 2];
