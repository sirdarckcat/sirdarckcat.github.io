"""GPU desert scanner: sieve + wave-Fermat for <=512-bit progressions.
...
Usage:
  python engine150.py spec.json KSTART KEND [--tile 2097152]
...
def main():
    ...
    assert (N0 + args.kend * M) < (1 << (32 * L)), "exceeds 512-bit capacity"
    nres = len(U)
